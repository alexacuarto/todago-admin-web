...
export default function ViewRequestModal({
  ...
  const stopsCount = viewingRequest.stops?.length || viewingRequest.totalStops || 1;
        ...
        <div className="bg-[#000C7D] text-white px-6 py-5 flex items-center justify-between">
          <div className="text-left">
            <span className="text-xs font-bold uppercase tracking-wider text-sky-200">
              {hasMultipleStops ? `Special Trip • ${stopsCount} Stops` : isRoundTrip ? "Round Trip" : "One Way Trip"}
            </span>
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-4 text-sm">
            ...
            <div>
              <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">
                {hasMultipleStops ? "Final Destination" : "Primary Destination"}
              </p>
            ...
            {hasMultipleStops && viewingRequest.stops && (
            ...
            <div>
              <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Booking Date & Time</p>
              <p className="font-bold text-slate-700 mt-0.5">
                {formatDateTime(viewingRequest.requestedAt || viewingRequest.time)}
              </p>
            </div>
            <div>
