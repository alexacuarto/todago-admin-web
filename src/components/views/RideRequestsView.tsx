      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 flex flex-col gap-4">
        <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
          <div className="shrink-0">
            <h2 className="text-[#000C7D] font-bold text-xl whitespace-nowrap">Ride Requests</h2>
          ...
          <div className="w-full xl:w-auto flex flex-wrap items-center gap-3">
            ...
            <div className="relative min-w-[145px] shrink-0">
              <select
                value={sortOrder}
            ...
            <div className="w-full sm:w-56 relative min-w-[180px]">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-bold shadow-xs hover:shadow-sm transition-all cursor-pointer whitespace-nowrap shrink-0"
            >
